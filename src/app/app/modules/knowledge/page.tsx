...
export default function KnowledgeModulePage() {
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-bold">Knowledge Module</h1>
        <p className="text-gray-500">Placeholder dashboard for the Knowledge capability.</p>
      </header>
      <Card>
        <CardHeader>
          <CardTitle>Welcome to Knowledge</CardTitle>
