...
export default function LearningModulePage() {
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-bold">Learning Module</h1>
        <p className="text-gray-500">Placeholder dashboard for the Learning capability.</p>
      </header>
      <Card>
        <CardHeader>
          <CardTitle>Welcome to Learning</CardTitle>
