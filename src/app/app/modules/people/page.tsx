...
export default function PeopleModulePage() {
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-2xl font-bold">People Module</h1>
        <p className="text-gray-500">Placeholder dashboard for the People capability.</p>
      </header>
      <Card>
        <CardHeader>
          <CardTitle>Welcome to People</CardTitle>
